...
public class GameState : Patterns.State
{
    ...
    public GameState(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id)
    {
        _puzzle = puzzle;
    }
...
public class GameState_FADEIN : GameState
{
    ...
    public GameState_FADEIN(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
{
    public GameState_WAIT(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
{
    public GameState_WIN(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
{
    public GameState_SHOW_AD(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
{
    public GameState_NEXT_PUZZLE_IMAGE(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
public class GameState_SHOW_HINT : GameState
{
    ...
    public GameState_SHOW_HINT(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
{
    private Puzzle.State _oldState;
    public GameState_CANCEL(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
{
    public GameState_SHOW_REWARD_AD(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
...
public class GameState_ASTAR_SOLUTION : GameState
{
    ...
    public GameState_ASTAR_SOLUTION(Patterns.FSM fsm, int id, PuzzleBoard puzzle) : base(fsm, id, puzzle)
    {
    }
    public override void Enter()
    {
