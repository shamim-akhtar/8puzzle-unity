...
namespace Games.Pathfinding {
	...
	public sealed class AStar
	{
		...
		public AStar(AStarNode AStartNode, AStarNode AGoalNode)
        {
            FOpenList = new Heap();
        ...
        public AStarNode NodeCurrent = null;
        ...
        public SearchResultEnum FindPath_Next()
        {
            if(FOpenList.Count > 0)
            {
                ...
                if (NodeCurrent.IsGoal())
                {
                    ...
                    return SearchResultEnum.SUCCESS; // found.
                }
                ...
                // Add the current node to the closed list
                FClosedList.Add(NodeCurrent);
                return SearchResultEnum.RUNNING;
            }
            return SearchResultEnum.FAILURE;
        }
